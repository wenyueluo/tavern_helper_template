/**
 * 立绘展示悬浮窗 —— 沉鸢不归（纯 jQuery 版）
 *
 * 图片：1~4.png = 日常照 / 5~6.png = 勃起状态
 */

// ══════════════════════════════════════════════════════════════
// 1. 立绘数据
// ══════════════════════════════════════════════════════════════
const ILLUST_BASE = 'https://raw.githubusercontent.com/wenyueluo/sillytraven/main/%E6%B2%89%E9%B8%A2%E4%B8%8D%E5%BD%92';

const categories = [
  {
    name: '日常',
    items: [
      { name: '日常照①', url: ILLUST_BASE + '/1.png' },
      { name: '日常照②', url: ILLUST_BASE + '/2.png' },
      { name: '日常照③', url: ILLUST_BASE + '/3.png' },
      { name: '日常照④', url: ILLUST_BASE + '/4.png' },
    ],
  },
  {
    name: '勃起',
    items: [
      { name: '勃起①', url: ILLUST_BASE + '/5.png' },
      { name: '勃起②', url: ILLUST_BASE + '/6.png' },
    ],
  },
];
...
$(function () {
  ...
  $('<span>').addClass('lh-head-title').text('立绘展示 — 沈鸢').appendTo($head);
